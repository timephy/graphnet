...
with open('/home/iwsatlas1/timg/remote/icedata/export/features_tilt_transformed.pkl', 'rb') as f:
    icedata_map = pickle.load(f)


def map_feature(feature: tuple):
    _, dom_x, dom_y, dom_z, *_ = feature

    icedata = icedata_map[dom_x, dom_y, dom_z]
    # print((dom_x, dom_y, dom_z), '=>', icedata)

    return *feature, *icedata[:2]


map_feature_vec = np.vectorize(map_feature)
...
if __name__ == '__main__':
    ...
    dataset = SQLiteDataset_IDON_Tilt(
        database=database,
