...
with open('/home/iwsatlas1/timg/remote/icedata/export/interp1d_quadratic_A.pkl', 'rb') as f:
    interp_A = pickle.load(f)
with open('/home/iwsatlas1/timg/remote/icedata/export/interp1d_quadratic_B.pkl', 'rb') as f:
